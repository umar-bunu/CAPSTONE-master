            ...
            actions: <Widget>[
              TextButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    else if (isConnected) await showAlertDialog2(context);
                  })
            ]),
        body: Container(
          child: Column(
    ...
    if (_device == null) {
      ...
      if (!isConnected) {
        await BluetoothConnection.toAddress(_device.address)
            .then((_connection) {
          print('Connected to the device at 298');
          print(_connection);
          ...
          print('Cannot connect, exception occurred at 315');
          print(error);
        });
  ...
  connect() async {
    try {
      ...
      connection.input.listen((Uint8List data) {
        print('data entry point');
        print(ascii.decode(data));
      });
    } catch (exception) {
      print('Cannot connect, exception occured at 359');
      print(exception);
    }
  }
}
...
Future<void> showAlertDialog2(BuildContext context) {
  AlertDialog alert2 = AlertDialog(
    title: Text("Warning !"),
    content: Text("You can't leave the app while the car is on !"),
  );
}
